...
generate-clientset-code: codegen-build
	docker run --rm \
		...
		"${CODEGEN_IMAGE}" \
		/go/src/k8s.io/code-generator/generate-groups.sh applyconfiguration,client,informer,lister ${PROJECT_MODULE}/apis/generated ${PROJECT_MODULE}/apis semaphorexds:v1alpha1 --go-header-file=/go/src/${PROJECT_MODULE}/boilerplate.go.tmpl
